...
// Prescripteur: manage own requests
router.post("/", authRequired, requireRoles("PRESCRIPTEUR"), ctrl.create);
...
router.put("/my/:id", authRequired, requireRoles("PRESCRIPTEUR"), ctrl.update);
...
router.post("/:id/apply", authRequired, requireRoles("ARTISAN"), ctrl.apply);
