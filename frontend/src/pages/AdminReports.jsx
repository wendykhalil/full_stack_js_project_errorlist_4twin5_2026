...
const SEVERITY = {
  ...
  HIGH:     { label: 'Ã‰levé',    color: 'bg-orange-100 text-orange-700' },
            ...
            <div className="p-7 space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  ...
                  { label: 'Sévérité',  value: SEVERITY[selectedReport.severity]?.label || selectedReport.severity || 'â€”' },
                      ...
                      <div key={idx} className="flex items-center gap-3 px-5 py-3">
                        ...
                        <div className="min-w-0">
                          <p className="text-sm font-semibold text-slate-800">
                            {item.action} <span className="font-normal text-slate-400">·</span> {item.fromStatus} â†’ {item.toStatus}
                          </p>
