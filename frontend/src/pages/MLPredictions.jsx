      ...
      <div className="flex-1 max-w-6xl mx-auto w-full px-4 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            des estimations fiables de durée, de coût et de risque de retard â€” adaptées au marché tunisien.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-4">
              Ã‰valuez la probabilité que votre projet prenne du retard avant même de commencer.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-sm text-gray-700">
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-gray-600">
                <li>Analyse le type de projet (maison, rénovation, commercialâ€¦)</li>
            ...
            <div>
              ...
              <ul className="space-y-2 list-disc list-inside text-gray-600">
                ...
                <li>Ã‰value l'expérience de l'artisan en années</li>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-green-800">
                <ul className="space-y-2">
                  <li className="flex items-start gap-2"><span className="font-bold shrink-0">â†’</span> Saisissez la surface réelle du projet, pas une estimation approximative</li>
                  <li className="flex items-start gap-2"><span className="font-bold shrink-0">â†’</span> Choisissez le niveau de complexité honnêtement â€” sous-estimer augmente le risque de retard</li>
                  <li className="flex items-start gap-2"><span className="font-bold shrink-0">â†’</span> Indiquez le nombre d'ouvriers que vous prévoyez réellement d'affecter</li>
                </ul>
                <ul className="space-y-2">
                  <li className="flex items-start gap-2"><span className="font-bold shrink-0">â†’</span> Pour un projet existant, utilisez "Projet existant" pour pré-remplir automatiquement</li>
                  <li className="flex items-start gap-2"><span className="font-bold shrink-0">â†’</span> Comparez les deux onglets (Durée &amp; Coût + Risque de Retard) pour une vision complète</li>
                  <li className="flex items-start gap-2"><span className="font-bold shrink-0">â†’</span> Utilisez ces estimations comme base de négociation avec vos clients</li>
                </ul>
              </div>
            </div>
          </div>
