  ...
  return (
    <div className="flex-1"> {/* Changed from main wrapper to flex-1 */}
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-600">Tableau de bord en mode simplifié. Utilisez le menu à gauche pour gérer les utilisateurs et consulter les logs.</p>
      </div>
