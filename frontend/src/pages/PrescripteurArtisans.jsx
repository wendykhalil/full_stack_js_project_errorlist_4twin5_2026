  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-4 flex items-center justify-between text-sm text-slate-600">
        <div>{t('prescripteurArtisans.projectsCompleted', { count: projects })}</div>
        <div>{t('prescripteurArtisans.yearsExperience', { count: years })}</div>
      </div>
...
export default function PrescripteurArtisans() {
  ...
  return (
    <div className="flex-1">
      <h1 className="text-3xl font-semibold text-slate-900">{t('prescripteurArtisans.title')}</h1>
      ...
      <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row">
          ...
          <div className="w-full md:w-72">
            <PillSelect placeholder={t('prescripteurArtisans.specialtyPlaceholder')} />
          </div>

          <div className="w-full md:w-64">
            <PillSelect placeholder={t('prescripteurArtisans.regionPlaceholder')} />
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <ArtisanCard
          name="Ali Ben Salem"
          job={t('prescripteurArtisans.specialties.plumbing')}
          city={t('prescripteurArtisans.cities.tunis')}
          projects={45}
          years={12}
          rating="4.8"
        />
        <ArtisanCard
          ...
          job={t('prescripteurArtisans.specialties.electricity')}
          city={t('prescripteurArtisans.cities.ariana')}
          projects={67}
          years={15}
          rating="4.9"
        />
        <ArtisanCard
          name="Karim Gharbi"
          job={t('prescripteurArtisans.specialties.masonry')}
          city={t('prescripteurArtisans.cities.benarous')}
          projects={38}
          years={10}
          rating="4.7"
        />
