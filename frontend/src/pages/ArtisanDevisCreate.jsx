            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Générez un devis professionnel et laissez l’IA vous proposer des lignes prêtes à ajuster.
                </p>
                {state?.projectTitle ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-slate-600">
                    Choisissez un projet puis cliquez sur <strong>Auto-remplir avec IA</strong> pour générer une base
            ...
            <form onSubmit={submit} className="mt-8 space-y-6">
              <div>
                ...
                <select
                  ...
                  className={`w-full rounded-xl border ${
                    formErrors.projectId || serverErrors.projectId ? "border-red-400" : "border-slate-200"
                ...
                {selectedProject ? (
                  <div className="mt-3 rounded-2xl bg-slate-50 p-4 text-xs text-slate-600">
                    <div className="grid gap-3 md:grid-cols-3">
                      ...
                      <div>
                        <span className="font-semibold text-slate-900">Surface:</span>{" "}
                        {selectedProject.surfaceM2 ? `${selectedProject.surfaceM2} m²` : "—"}
                      </div>
                    </div>
                  </div>
                ) : null}
              ...
              <div className="space-y-3">
                {lines.map((line, index) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => setLines((prev) => prev.filter((_, i) => i !== index || prev.length === 1))}
              ...
              <div className="rounded-2xl bg-slate-50 p-4 text-sm text-slate-700">
                <div className="flex justify-between">
                  ...
                  <strong>{totals.subTotal.toFixed(3)} TND</strong>
                </div>
                <div className="mt-2 flex justify-between">
                  <span>TVA 19%</span>
                  <strong>{totals.taxAmount.toFixed(3)} TND</strong>
                </div>
                <div className="mt-2 flex justify-between text-base">
                  <span>Total</span>
                  <strong>{totals.total.toFixed(3)} TND</strong>
                </div>
              </div>
