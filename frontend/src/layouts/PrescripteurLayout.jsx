...
import { FolderKanban, MessageCircle, PackageSearch, Search, Shield, UserCircle2, Users, ClipboardList, Brain, Calendar, AlertTriangle } from "lucide-react";
...
export default function PrescripteurLayout() {
  ...
  const navItems = [
    ...
    { to: "/prescripteur/disputes", label: "Litiges", icon: <AlertTriangle className="h-5 w-5" /> },
    { to: "/prescripteur/meetings", label: "Réunions", icon: <Calendar className="h-5 w-5" /> },
