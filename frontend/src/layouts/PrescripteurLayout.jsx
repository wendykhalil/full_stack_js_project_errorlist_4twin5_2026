          ...
          <div className="flex items-center gap-3">
            ...
            {!isSidebarCollapsed && (
              <div>
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400">Prescripteur</div>
              </div>
            )}
          </div>
        </div>
            ...
            {!isSidebarCollapsed && (
              <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold text-slate-900 dark:text-white truncate">
                  {[user?.firstName, user?.lastName].filter(Boolean).join(" ") || "Prescripteur"}
                </div>
                <div className="text-xs text-slate-500 dark:text-slate-400">Prescripteur</div>
              </div>
            )}
          ...
          <div className="mx-auto flex items-center justify-between p-5">
            <div>
              ...
              <div className="hidden sm:block text-xs text-slate-500 dark:text-slate-400">
                Prescripteur • {[user?.firstName, user?.lastName].filter(Boolean).join(" ")}
              </div>
            </div>
