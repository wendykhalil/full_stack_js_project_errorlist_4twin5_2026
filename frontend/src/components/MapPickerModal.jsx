    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      <div className="relative flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl">
        <div className="flex items-start justify-between gap-4 border-b border-slate-200 px-6 py-5">
          <div>
            <h3 className="text-xl font-semibold text-slate-900">Choisir la localisation du projet</h3>
            <p className="mt-1 text-sm text-slate-500">Cliquez sur la carte ou utilisez votre position actuelle.</p>
          </div>
        ...
        <div className="grid gap-0 lg:grid-cols-[1.3fr,0.7fr]">
          <div className="relative min-h-[420px] bg-slate-100">
            {(loadingMap || geocodeLoading) && (
              <div className="absolute right-4 top-4 z-[400] inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 text-xs font-medium text-slate-700 shadow">
                ...
                {loadingMap ? 'Chargement de la carte...' : 'Recherche des details du lieu...'}
              </div>
            )}
          ...
          <div className="space-y-4 p-6">
            ...
            >
              ...
              {locating ? 'Recuperation de votre position...' : 'Utiliser ma position actuelle'}
            </button>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
              <div className="flex items-center gap-2 font-semibold text-slate-900">
                <MapPin className="h-4 w-4 text-indigo-600" /> Lieu selectionne
              </div>
              <div className="mt-3 space-y-2">
                ...
                <div>
                  <div className="text-xs uppercase tracking-wide text-slate-400">Adresse</div>
